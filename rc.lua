...
awful.util.tagnames = { "www", "main", "dev", "docs", "media" }
...
globalkeys = awful.util.table.join(
    ...
    --Brightness
    awful.key({ altkey, "Control" }, "Up", function () os.execute("sudo tee /sys/class/backlight/radeon_bl0/brightness <<< $(($(< /sys/class/backlight/radeon_bl0/brightness) + 5))") end),
    awful.key({ altkey, "Control" }, "Down", function () os.execute("sudo tee /sys/class/backlight/radeon_bl0/brightness <<< $(($(< /sys/class/backlight/radeon_bl0/brightness) - 5))") end),
